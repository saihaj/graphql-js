...
export { SubscriptionArgs } from './subscription/index';
...
export { ValidationRule } from './validation/index';
...
export { GraphQLFormattedError } from './error/index';
...
export {
  ...
  buildSchema, // Extends an existing GraphQLSchema from a parsed GraphQL Schema
  // language AST.
